        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    <!-- {amount_total_label} -->
                    <td colspan="2">{{ currency_formatter($invoice->total,'') }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td> {{ currency_formatter($invoice->amountPaid(),'') }}</td>
                </tr>
                <tr>
                            ...
                            <table class="table table-hover">
                                ...
                                @forelse($payments as $key => $payment)
                                    <tr>
                                        ...
                                        <td class="text-center">{!! $invoice->currency->currency_symbol !!} {{  currency_formatter($payment->amount, $invoice->currency->currency_symbol) }}  </td>
